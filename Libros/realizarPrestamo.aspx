<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="realizarPrestamo.aspx.cs" Inherits="Libros.realizarPrestamo" %>
    ...
    <nav>
        ...
        <section>
            <article>
                ...
                <p>En esta sección, realizaremos prestamos para los Usuarios del sistema. Favor, ingresar el codigo ISBN del Libro.</p>
                <p>
